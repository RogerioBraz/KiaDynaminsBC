...
//         TempExcelBuffer.AddColumn('Item No.', false, false, false, true, '', false);
//         TempExcelBuffer.AddColumn('Usage Type', false, false, false, true, '', false);
//         TempExcelBuffer.AddColumn('Has Implement', false, false, false, true, '', false);
//         TempExcelBuffer.AddColumn('Effective Start Date', false, false, false, true, '', false);
//         TempExcelBuffer.AddColumn('Max Mileage', false, false, false, true, '', false);
//         TempExcelBuffer.AddColumn('Max Age', false, false, false, true, '', false);
//         TempExcelBuffer.AddColumn('Tabulated Age', false, false, false, true, '', false);
//         TempExcelBuffer.AddColumn('Residual Value %', false, false, false, true, '', false);
//         TempExcelBuffer.AddColumn('Status', false, false, false, true, '', false);
//         TempExcelBuffer.AddColumn('MSRP Record', false, false, false, true, '', false);

//         // Add sample row
//         TempExcelBuffer.NewRow();
//         TempExcelBuffer.AddColumn('CC-XRE', false, false, false, false, '', false);
//         TempExcelBuffer.AddColumn('Normal', false, false, false, false, '', false);
//         TempExcelBuffer.AddColumn('FALSE', false, false, false, false, '', false);
//         TempExcelBuffer.AddColumn(Format(Today, 0, '<Day,2>/<Month,2>/<Year4>'), false, false, false, false, '', false);
//         TempExcelBuffer.AddColumn('20000', false, false, false, false, '', false);
//         TempExcelBuffer.AddColumn('12', false, false, false, false, '', false);
//         TempExcelBuffer.AddColumn('12', false, false, false, false, '', false);
//         TempExcelBuffer.AddColumn('87.81', false, false, false, false, '', false);
//         TempExcelBuffer.AddColumn('Active', false, false, false, false, '', false);
//         TempExcelBuffer.AddColumn('FALSE', false, false, false, false, '', false);
